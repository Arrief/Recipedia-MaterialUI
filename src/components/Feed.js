    ...
    <Box flex={4} p={2}> 
      <Card sx={{mb: 4}}>
        ...
        <CardContent>
          ...
          This Indian Red Lentil Dal (Masoor Dal) with sweet potatoes, fragrant spices and creamy coconut milk is one of my favorite vegan weeknight dinner recipes.
      ...
      <Card sx={{mb: 4}}>
          <CardHeader
            avatar={
              <Avatar sx={{color: "black", bgcolor: "yellow"}} aria-label="recipe">
                JS
              </Avatar>
            }
            action={
